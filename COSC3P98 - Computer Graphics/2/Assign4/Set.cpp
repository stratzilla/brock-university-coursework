 ...
 *
 * initially this was a separate Mandelbrot class
 * and I had a further class for Burning Ship
 * but they've been combined to a generalized "set" class
 * I didn't combine it with Fractal because Fractal is big enough
 */
